...
Analysis.init({
  ...
  datasetId: { type: DataTypes.INTEGER, allowNull: false , references: {model: "datasets", key: "id"}},
...
}, { sequelize: sqlize, modelName: "analyse", tableName: "analyses", timestamps: true });
