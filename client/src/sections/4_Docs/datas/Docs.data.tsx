...
export const TEST_TYPES = Object.freeze([
  {
    ...
    description:
      "Compare means between two independent groups under equal variance assumption",
    example: "Comparing test scores between treatment and control groups",
  },
  {
    name: "Paired t-test",
    description:
      "Compare means from the same subjects at two different times or conditions",
    example:
      "Measuring blood pressure before and after treatment on the same participants",
  },
  {
    name: "One-way ANOVA",
